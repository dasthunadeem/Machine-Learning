...
plt.title('Accuracy of Naive_Bayes_Model Model:Training_data is {:.2f} %'.format(Accuracy_train))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()
...
plt.title('Accuracy of Naive_Bayes_Model Model:Testing_data is {:.2f} %'.format(Accuracy_test))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()

print('Accuracy of Naive_Bayes_Model Model is : {:.2f}% '.format(Accuracy_test))
