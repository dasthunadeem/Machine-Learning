...
#Fitting the data to Decision_Tree Module:
...
plt.title('Accuracy of Decision_Tree Model:Training_data is {:.2f} %'.format(Accuracy_train))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()
...
plt.title('Accuracy of Decision_Tree Model:Testing_data is {:.2f} %'.format(Accuracy_test))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()

print('Accuracy of Decision_Tree Model is : {:.2f}% '.format(Accuracy_test))
