...
#Fitting the data to KNN Module:
...
plt.title('Accuracy of KNN Model:Training_data is {:.2f} %'.format(Accuracy_train))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()
...
plt.title('Accuracy of KNN Model:Testing_data is {:.2f} %'.format(Accuracy_test))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()

print('Accuracy of KNN Model is : {:.2f}% '.format(Accuracy_test))
