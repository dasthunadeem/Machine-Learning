...
#Fitting the data to SVM Module:
...
plt.title('Accuracy of SVM Model:Training_data is {:.2f} %'.format(Accuracy_train))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()
...
plt.title('Accuracy of SVM Model:Testing_data is {:.2f} %'.format(Accuracy_test))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()

print('Accuracy of SVM Model is : {:.2f}% '.format(Accuracy_test))
