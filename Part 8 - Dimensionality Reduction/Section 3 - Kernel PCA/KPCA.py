...
plt.title('Training Set and Accuracy of Linear Reg Model with KPCA is {:.2f} %'.format(Accuracy_train))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()
...
plt.title('Testing Set and Accuracy of Linear Reg Model with KPCA is {:.2f} %'.format(Accuracy_test))
plt.legend()
plt.xlabel('Age')
plt.ylabel('Salary')
plt.show()