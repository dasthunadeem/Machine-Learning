...
Only difference with PCA is that here we consider depedent variable and
based on the categories or cluster in the dependent variable 
it selects the best Eigen Vector,i.e Variance
'''
